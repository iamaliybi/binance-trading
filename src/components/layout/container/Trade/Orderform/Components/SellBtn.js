...
const SellBtn = ({ authorize, symbol }) => {
	...
	return (
		<>
			{authorize
				?
				<button type='submit' className='flex items-center justify-center font-medium text-base bg-red text-white rounded h-40'>
					{t('trd-openOrde-sideSell') + ' ' + symbol.base}
				</button>
				:
...
export default connect(mapStateToProps)(SellBtn);
